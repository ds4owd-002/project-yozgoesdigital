...
#| tbl-cap: "Count of number of trips recorded "
...
#| fig-subcap: "This map is interactive. By hovering over the icon on the right top it allows the reader to make filters and select background maps"
pal <- colorFactor(
