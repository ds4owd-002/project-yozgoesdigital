...
The original set [@lars_schobitz_data_nodate] has 2 tables. One containing information of trips and the second table with metadata on the trucks: \### Trips
...
dataset: https://github.com/openwashdata/fslogisticskampala/blob/main/LICENSE.md
